 ...
 * @author Abhishek
 */
public class ManageCDCPaymentAccountJPanel extends javax.swing.JPanel {
    ...
    public ManageCDCPaymentAccountJPanel(JPanel upc,EcoSystem system,UserAccount userAccount) {
        initComponents();
        this.upc = upc;
    ...
    private void btnPayBillsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPayBillsActionPerformed
        // TODO add your handling code here:
        CDCOrderBillPaymentJPanel cdcobpjp = new CDCOrderBillPaymentJPanel(upc, userAccount ,system);
        CardLayout layout = (CardLayout) upc.getLayout();
        upc.add("CDCOrderBillPaymentJPanel", cdcobpjp);
        layout.next(upc);
