 ...
 * @author Abhishek
 */
public class ManageSitePaymentAccountsJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageSitePaymentAccountsJPanel(JPanel upc,SiteEnterprise siteEnterprise,UserAccount userAccount,EcoSystem system) {
        initComponents();
        this.upc = upc;
    ...
    private void initComponents() {
        ...
        if (tblTransactionHist.getColumnModel().getColumnCount() > 0) {
            tblTransactionHist.getColumnModel().getColumn(0).setResizable(false);
            tblTransactionHist.getColumnModel().getColumn(1).setResizable(false);
            tblTransactionHist.getColumnModel().getColumn(2).setResizable(false);
            tblTransactionHist.getColumnModel().getColumn(3).setResizable(false);
            tblTransactionHist.getColumnModel().getColumn(4).setResizable(false);
        }
    ...
    private void btnPayBillsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPayBillsActionPerformed
        // TODO add your handling code here:
        SiteOrderBillPaymentJPanel sobpjp = new SiteOrderBillPaymentJPanel(upc, userAccount ,siteEnterprise, system);
        CardLayout layout = (CardLayout) upc.getLayout();
        upc.add("SiteOrderBillPaymentJPanel", sobpjp);
        layout.next(upc);
