 ...
 * @author Abhishek
 */
public class SiteOrderBillPaymentJPanel extends javax.swing.JPanel {
     ...
     */
    public SiteOrderBillPaymentJPanel(JPanel upc,UserAccount userAcc,SiteEnterprise site,EcoSystem system) {
        initComponents();
        this.upc = upc;
    ...
    public void populateTable(){
        ...
        for(WorkRequest req : userAcc.getWorkQueue().getWorkRequestList()){
            if(req.getOrder()!=null && req.getOrder().getStatus().equals("Order Approved And Shipped")){
