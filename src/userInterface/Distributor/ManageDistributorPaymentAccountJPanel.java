 ...
 * @author Abhishek
 */
public class ManageDistributorPaymentAccountJPanel extends javax.swing.JPanel {
    ...
    public ManageDistributorPaymentAccountJPanel(JPanel upc,EcoSystem system,DistributorEnterprise distributorEnterprise,UserAccount userAccount) {
        initComponents();
        this.upc = upc;
    ...
    private void btnPayBillsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPayBillsActionPerformed
        // TODO add your handling code here:
        DistributorOrderBillPaymentJPanel dobpjp = new DistributorOrderBillPaymentJPanel(upc, userAccount,distributorEnterprise ,system);
        CardLayout layout = (CardLayout) upc.getLayout();
        upc.add("DistributorOrderBillPaymentJPanel", dobpjp);
        layout.next(upc);
